...
from .bot.command_router import VERSION, CommandRouter
...
from .web.dashboard import dashboard_state, start_dashboard_thread
...
async def main() -> None:
    ...
    if (
        ollama_cloud_cfg
        and ollama_cloud_cfg.enabled
        and app_config.ollama_cloud_url
        and app_config.ollama_api_key
    ):
